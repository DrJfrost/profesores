function Quica(){
	...
	this.sprite = 0;
	this.vida = 100;
	this.puntos = 0; // Inicialización de los puntos
	this.seguro = "arriba";
	...
	this.dibujar = function(ctx){
		...
		ctx.save();
		ctx.fillStyle = "#11DEFA";
		ctx.font = "17px Aharoni";
		ctx.fillText("Puntos: "+ this.puntos, x, y + 60);
		ctx.fillText("HP: "+ this.vida, x, y);
		ctx.fillText("Seguro: "+ this.seguro, x, y+80);
		if(this.sprite==2){
			ctx.fillStyle = "#FF0808";
			ctx.font = "20px Aharoni";
			ctx.fillText("!!!", x+65, y + 25); //Cuando colisiona
		}
		ctx.restore();
	}
